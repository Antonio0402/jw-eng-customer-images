<?php
use JW_Eng_Customer_Images\Includes\i18n;
use JW_Eng_Customer_Images\Includes\Dependency_Loader;
use JW_Eng_Customer_Images\Core\Registry\Controller as Controller_Registry;
use JW_Eng_Customer_Images\Core\Registry\Controller as Model_Registry;
use JW_Eng_Customer_Images\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'JW_Eng_Customer_Images' ) ) {
	 ...
	 */
	class JW_Eng_Customer_Images extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      JW_Eng_Customer_Images    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( JW_Eng_Customer_Images::PLUGIN_ID );
