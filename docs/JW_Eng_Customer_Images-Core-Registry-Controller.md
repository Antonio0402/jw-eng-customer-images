JW_Eng_Customer_Images\Core\Registry\Controller
===============
...
### get_key
    ...
    string JW_Eng_Customer_Images\Core\Registry\Controller::get_key(string $controller_class_name, string $model_class_name, string $view_class_name)
...
### set
    ...
    void JW_Eng_Customer_Images\Core\Registry\Controller::set(string $key, mixed $value)
...
### get
    ...
    mixed JW_Eng_Customer_Images\Core\Registry\Controller::get(string $key)
...
### get_all_objects
    ...
    array JW_Eng_Customer_Images\Core\Registry\Controller::get_all_objects()
