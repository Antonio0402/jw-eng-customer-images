JW_Eng_Customer_Images\Includes\Requirements_Checker
===============
...
* Namespace: JW_Eng_Customer_Images\Includes
...
### __construct
    ...
    mixed JW_Eng_Customer_Images\Includes\Requirements_Checker::__construct(array $requirements_data)
...
### is_php_version_dependency_met
    ...
    boolean JW_Eng_Customer_Images\Includes\Requirements_Checker::is_php_version_dependency_met()
...
### is_wp_version_dependency_met
    ...
    boolean JW_Eng_Customer_Images\Includes\Requirements_Checker::is_wp_version_dependency_met()
...
### is_wp_multisite_dependency_met
    ...
    boolean JW_Eng_Customer_Images\Includes\Requirements_Checker::is_wp_multisite_dependency_met()
...
### is_plugin_active
    ...
    boolean JW_Eng_Customer_Images\Includes\Requirements_Checker::is_plugin_active(string $jw_eng_customer_images, string $plugin_slug)
...
#### Arguments
* $jw_eng_customer_images **string** - &lt;p&gt;Name of the plugin.&lt;/p&gt;
...
### get_plugin_version
    ...
    string JW_Eng_Customer_Images\Includes\Requirements_Checker::get_plugin_version(string $plugin_slug)
...
### is_required_plugin_version_active
    ...
    boolean JW_Eng_Customer_Images\Includes\Requirements_Checker::is_required_plugin_version_active(string $jw_eng_customer_images, string $plugin_slug, string $min_plugin_version)
...
#### Arguments
* $jw_eng_customer_images **string** - &lt;p&gt;JW Eng Customer Images.&lt;/p&gt;
...
### are_required_plugins_dependency_met
    ...
    boolean JW_Eng_Customer_Images\Includes\Requirements_Checker::are_required_plugins_dependency_met()
...
### add_error_notice
    ...
    void JW_Eng_Customer_Images\Includes\Requirements_Checker::add_error_notice(string $error_message, string $supportive_information)
...
### requirements_met
    ...
    boolean JW_Eng_Customer_Images\Includes\Requirements_Checker::requirements_met()
...
### show_requirements_errors
    ...
    mixed JW_Eng_Customer_Images\Includes\Requirements_Checker::show_requirements_errors()
