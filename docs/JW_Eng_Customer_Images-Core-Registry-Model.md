JW_Eng_Customer_Images\Core\Registry\Model
===============
...
### set
    ...
    void JW_Eng_Customer_Images\Core\Registry\Model::set(string $key, mixed $value)
...
### get
    ...
    mixed JW_Eng_Customer_Images\Core\Registry\Model::get(string $key)
...
### get_all_objects
    ...
    array JW_Eng_Customer_Images\Core\Registry\Model::get_all_objects()
