...
use JW_Eng_Customer_Images\Core\Route_Type as Route_Type;
...
|		>with_controller( 'Admin_Settings' ) // Resolved by Router to 'JW_Eng_Customer_Images\App\Controllers\Admin\Admin_Settings'.
|		->with_model( 'Admin_Settings' ) // Resolved by Router to 'JW_Eng_Customer_Images\App\Models\Admin\Admin_Settings'.
|		->with_view( 'Admin_Settings' ); // Resolved by Router to 'JW_Eng_Customer_Images\App\Views\Admin\Admin_Settings'.
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_controller( 'JW_Eng_Customer_Images\App\Controllers\Admin\Admin_Settings' )
|		->with_model( 'JW_Eng_Customer_Images\App\Models\Admin\Admin_Settings' )
|		->with_view( 'JW_Eng_Customer_Images\App\Views\Admin\Admin_Settings' );
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_just_model('JW_Eng_Customer_Images_Model_Admin_Settings');
|-------------------------------------------------------------------------------------------
*/
...
$router
	->register_route_of_type( ROUTE_TYPE::ADMIN )
	->with_controller( 'Admin_Settings@register_hook_callbacks' ) // Resolved by Router to 'JW_Eng_Customer_Images\App\Controllers\Admin\Admin_Settings'.
	->with_model( 'Admin_Settings' ) // Resolved by Router to 'JW_Eng_Customer_Images\App\Models\Admin\Admin_Settings'.
	->with_view( 'Admin_Settings' ); // Resolved by Router to 'JW_Eng_Customer_Images\App\Views\Admin\Admin_Settings'.
